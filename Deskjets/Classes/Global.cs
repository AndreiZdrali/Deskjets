...
namespace Deskjets.Classes
{
    static class Global
    {
        public static string ExecutablePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Deskjets.exe");
        ...
        static Global()
        {
            ...
            notifyIcon.ContextMenuStrip.Items.Add("-");
            notifyIcon.ContextMenuStrip.Items.Add("Manage Top Bar", null, (s, e) => Utils.OpenWindow<ManageTopBarWindow>(true));
            notifyIcon.ContextMenuStrip.Items.Add("-");
